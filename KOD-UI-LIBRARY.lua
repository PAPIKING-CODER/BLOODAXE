...
local function createToggleIcon()
    ...
    btn.Image = 'https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=101040722102653'
...
function Update:Window(patchText)
    ...
    hideBtn.Image = 'https://www.roblox.com/Thumbs/Asset.ashx?width=420&height=420&assetId=101040722102653'
    ...
    transparencyBtn.Position = UDim2.new(1, -42, 0.5, 0)
